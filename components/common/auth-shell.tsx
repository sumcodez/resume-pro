...
export async function AuthShell({ children }: AuthShellProps) {
  return (
    <main className="relative min-h-screen overflow-hidden bg-background">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,color-mix(in_oklch,var(--border)_58%,transparent)_1px,transparent_1px),linear-gradient(to_bottom,color-mix(in_oklch,var(--border)_58%,transparent)_1px,transparent_1px)] bg-size-[44px_44px] opacity-35 mask-[radial-gradient(ellipse_at_center,black_30%,transparent_76%)]" />
      <div className="pointer-events-none absolute left-1/2 top-0 h-80 w-2xl -translate-x-1/2 rounded-full bg-primary/18 blur-3xl" />
